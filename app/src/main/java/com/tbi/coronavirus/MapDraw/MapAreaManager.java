package com.tbi.coronavirus.MapDraw;
...
import static com.tbi.coronavirus.MapDraw.MapAreaWrapper.MarkerMoveResult.maxRadius;
import static com.tbi.coronavirus.MapDraw.MapAreaWrapper.MarkerMoveResult.minRadius;
import static com.tbi.coronavirus.MapDraw.MapAreaWrapper.MarkerMoveResult.moved;
import static com.tbi.coronavirus.MapDraw.MapAreaWrapper.MarkerMoveResult.radiusChange;
...
public class MapAreaManager implements OnMarkerDragListener, OnMapLongClickListener {
     ...
     */
	public MapAreaManager(GoogleMap map, int strokeWidth, int strokeColor, int circleColor,
						  float v, float v1, float v2, float v3, MapAreaMeasure initRadius, CircleManagerListener circleManagerListener) {
